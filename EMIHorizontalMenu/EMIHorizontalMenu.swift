//
//  EMIHorizontalMenu.swift
//  Panchayat
//
//  Created by Imran Malik on 9/21/17.
//  Copyright © 2017 Apra upadhyay. All rights reserved.
//
...
class EMIHorizontalMenu: UIScrollView ,UIScrollViewDelegate {
    ...
    func setup(){
        ...
        selectedMenu.topAnchor.constraint(equalTo: self.topAnchor, constant: (self.frame.height - selectedMenuHeight)).isActive = true
